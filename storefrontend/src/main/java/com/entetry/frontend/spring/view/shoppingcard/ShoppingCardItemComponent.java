...
public class ShoppingCardItemComponent extends HorizontalLayout {
    ...
    public ShoppingCardItemComponent(ShoppingCardService shoppingCardService){
        ...
        deleteItemButton.addClickListener(event->shoppingCardService.deleteItemFromShoppingCard(itemDto)
                );
        bind();
    }
    private void bind(){
